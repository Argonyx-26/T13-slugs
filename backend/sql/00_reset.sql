...
-- Only for starting over in an existing project. Afterwards run 01, 02, 04, 03, then `python -m rag.seed`.
...
drop function if exists search_patient_memory, find_similar_patients, clear_doctor_memory,
                        ...
                        visit_queue, match_patient_chunks, hybrid_patient_chunks,
                        match_similar_patients, reset_doctor_memory;

drop table if exists visits, patient_identity, memory_chunks, doctor_hidden_patients, doctor_notes, clinic_records,

-- Run after 01, 02 and 04. Expected: 7 tables (rls_on = true), 8 functions, and every "backend can ..." row = false.
...
where n.nspname = 'public'
  and p.proname in ('search_patient_memory', 'find_similar_patients', 'clear_doctor_memory', 'receptionist_delete_patient',
                    'check_in', 'register_patient', 'search_patients', 'visit_queue')
union all
